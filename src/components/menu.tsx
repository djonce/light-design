...
function Menu(props: MenuProps): JSX.Element {
  ...
  const [menulist] = useState<any>([
    ...
    // {
    //   name: '问题反馈',
    //   link: 'https://github.com/djonce/light-design/issues',
    // },
  ]);
  const [menuIndex, setMenuIndex] = useState<number>(
    sessionStorage.getItem('mIndex')
      ? Number(sessionStorage.getItem('mIndex'))
      : 1
  );
          ...
          <div className="menuInnerBox">
            ...
            <div className="linsArea1">
              ...
              {/* <span
                className="npm"
                onClick={() =>
                  window.open('https://www.npmjs.com/package/lightdui-rt')
                }
              /> */}
            </div>
          </div>
